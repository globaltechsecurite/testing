...
const Projects = () => {
  ...
  return (
    <div className={styles._projects}>
      <div className={styles._projects_header}>
        <div className={styles._projects_header_title}>
          <h2>Nos Projets Réalisés.</h2>
        </div>
        <div className={styles._projects_header_subtitle}>
          <p>
            Découvrez comment notre savoir-faire et notre expertise transforment
            des visions en réalisations exceptionnelles. Chaque projet est une
            nouvelle histoire d&apos;élégance et d&apos;innovation.
          </p>
        </div>
        <div
          className={`${styles._projects_header_nextBtn} swiper-button-next`}
        >
          <svg
            width="60px"
            height="60px"
        ...
        <div
          className={`${styles._projects_header_leftBtn} swiper-button-prev`}
        >
          <svg
            width="60px"
            height="60px"
      ...
      <div className={styles._projects_child} id="swiperProjects">
        <Swiper
        ...
        >
          {projectsData.map((prj, i) => {
            return (
              <SwiperSlide key={i} className={styles._projects_child_op}>
                <div className={styles._projects_child_op_title}>
                  <h3>{prj.title}</h3>
                </div>
                <div className={styles._projects_child_op_date}>
                  <p>{prj.date}</p>
                </div>
              </SwiperSlide>
            );
